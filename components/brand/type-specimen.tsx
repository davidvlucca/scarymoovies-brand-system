...
const TYPE_STYLES: Record<TypeLevel, {
  ...
  display: {
    ...
    label: "Display — Inter Black 900 · uppercase · −0.03em tracking",
  },
  h1: {
    ...
    label: "Heading 1 — Inter Bold 700 · 36px · −0.02em tracking",
  },
  h2: {
    ...
    fontFamily: "var(--font-display)",
    letterSpacing: "-0.02em",
    label: "Heading 2 — Inter Bold 700 · 30px · −0.02em tracking",
  },
  h3: {
    fontSize: "1.25rem",
    fontWeight: 600,
